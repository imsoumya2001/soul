...
const GradientSvg: React.FC<GradientSvgProps> = ({
  ...
  const transitionHovered = { duration: 50, repeat: Infinity, ease: "linear" as Easing };
  const transitionNotHovered = { duration: 10, repeat: Infinity, ease: "linear" as Easing };
    ...
    >
      ...
      <defs>
        <motion.radialGradient
          ...
          transition={isHovered ? transitionHovered : transitionNotHovered}
        >
